...
<div class="dropdown">
    <button class="btn btn-th btn-default dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown"
            aria-haspopup="true" aria-expanded="true">
        <?php
        echo \Yii::t('orders', 'orders.services') ?>
        <span class="caret"></span>
    </button>

    <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
        <li class="<?php
        echo empty($requestServices) ? 'active' : '' ?>"><a href="<?php
            echo UrlHelper::getPathWithParams(['service_id' => 0]) ?>">All (<?php
                echo $sumServicesList ?>")</a></li>
        <?php
